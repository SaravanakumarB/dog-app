package com.example.dog_app.activity
...
import com.example.dog_app.application.DogApplication
 ...
 * [com.example.dog_app.fragment.InjectableFragment].
 */
open class InjectableAppCompatActivity : AppCompatActivity() {
  /**
  ...
  private fun initializeActivityComponent() {
    activityComponent =
      (application as DogApplication).createActivityComponent(this)
  }
